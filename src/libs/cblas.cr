...
lib LibCblas
  ...
  fun dtbsv = cblas_dtbsv(order : MatrixLayout, uplo : CblasUplo, trans_a : CblasTranspose, diag : CblasDiag, n : Blasint, a : LibC::Double*, lda : Blasint, x : LibC::Double*, inc_x : Blasint)
  ...
  fun ztbsv = cblas_ztbsv(order : MatrixLayout, uplo : CblasUplo, trans_a : CblasTranspose, diag : CblasDiag, n : Blasint, a : LibC::Double*, lda : Blasint, x : LibC::Double*, inc_x : Blasint)
  ...
  fun dsyr2k = cblas_dsyr2k(order : MatrixLayout, uplo : CblasUplo, trans : CblasTranspose, n : Blasint, k : Blasint, alpha : LibC::Double, a : LibC::Double*, lda : Blasint, b : LibC::Float*, ldb : Blasint, beta : LibC::Float, c : LibC::Float*, ldc : Blasint)
  ...
  fun comatcopy = cblas_comatcopy(corder : MatrixLayout, ctrans : CblasTranspose, crows : Blasint, ccols : Blasint, calpha : LibC::Float*, a : LibC::Float*, lda : Blasint, b : LibC::Float*, ldb : Blasint)
